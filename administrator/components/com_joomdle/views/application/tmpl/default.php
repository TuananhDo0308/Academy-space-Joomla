...
<?php
echo "<b>".JText::_('COM_JOOMDLE_USER').": </b>".$this->app_info['name'] . "<br>";
...
switch ($this->app_info['state'])
{
    case JOOMDLE_APPLICATION_STATE_APPROVED:
        echo '<img src="'.JURI::root ().'/media/joomdle/images/tick.png" width="16" height="16" border="0" alt="" />';
        break;
    case JOOMDLE_APPLICATION_STATE_REJECTED:
        echo '<img src="'.JURI::root ().'/media/joomdle/images/publish_r.png" width="16" height="16" border="0" alt="" />';
        break;
    default:

...
?>
  <?php if(!empty( $this->sidebar)): ?>
    ...
    <?php endif;?>
       ...
       <br>
<center><?php echo JText::_('COM_JOOMDLE_FOR_PROBLEM_RESOLUTION_SEE'); ?>: <a target='_blank' href="https://www.joomdle.com/wiki/System_health_check">https://www.joomdle.com/wiki/System_health_check</a></center>
</div>

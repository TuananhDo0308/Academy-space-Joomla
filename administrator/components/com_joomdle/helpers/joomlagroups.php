...
class JoomdleHelperJoomlagroups
{
    ...
    static function update_group ($course_id, $group_name, $type)
    {
        $group_id = JoomdleHelperJoomlagroups::get_course_group_id ($course_id, $type);
    ...
    static function update_course_groups ($course_id, $course_name)
    {
        $group_name = $course_name . ' (' . JText::_('COM_JOOMDLE_TEACHERS') . ')';
        JoomdleHelperJoomlagroups::update_group ($course_id, $group_name, 'teachers');
        $group_name = $course_name . ' (' . JText::_('COM_JOOMDLE_STUDENTS') . ')';
        JoomdleHelperJoomlagroups::update_group ($course_id, $group_name, 'students');
    }

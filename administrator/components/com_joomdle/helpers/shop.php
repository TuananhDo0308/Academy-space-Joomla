...
class JoomdleHelperShop
{
    ...
    static function is_course_on_sell ($course_id)
    {
        ...
        $result = JFactory::getApplication()->triggerEvent ('onIsCourseOnSell', array($course_id));
    ...
    static function getShopCourses ()
    {
        ...
        $courses = array ();
        JPluginHelper::importPlugin( 'joomdleshop' );
        $result = JFactory::getApplication()->triggerEvent ('onGetShopCourses', array());
    ...
    static function get_sell_url ($course_id)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleshop' );
        $result = JFactory::getApplication()->triggerEvent ('onGetSellUrl', array ($course_id));
    ...
    static function sell_courses ($courses)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleshop' );
        JFactory::getApplication()->triggerEvent ('onSellCourses', array ($courses));
    }
    ...
    static function dont_sell_courses ($courses)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleshop' );
        JFactory::getApplication()->triggerEvent ('onDontSellCourses', array ($courses));
    }
    ...
    static function reload_courses ($courses)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleshop' );
        JFactory::getApplication()->triggerEvent ('onReloadCourses', array ($courses));
    }
    ...
    static function delete_courses ($courses)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleshop' );
        JFactory::getApplication()->triggerEvent ('onDeleteCourses', array ($courses));
    }
    ...
    static function create_bundle ($bundle)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleshop' );
        JFactory::getApplication()->triggerEvent ('onCreateBundle', array ($bundle));
    }

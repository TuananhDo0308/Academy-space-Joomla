    ...
    static function save_course_mailing_list ($course_id, $type = 'course_students')
    {
        ...
        switch ($ml)
        {
            ...
            default:
                ...
                $result = JFactory::getApplication()->triggerEvent ('onJoomdleSaveList', array ($data));
                $list_id = array_shift ($result);
                break;
        }
    ...
    static function add_sub ($list_id, $user_id)
    {
        ...
        switch ($ml)
        {
            ...
            default:
                ...
                JPluginHelper::importPlugin( 'joomdlemailinglist' );
                $result = JFactory::getApplication()->triggerEvent ('onJoomdleAddListSub', array ($data));
                break;
        }
    }
    ...
    static function remove_sub ($list_id, $user_id)
    {
        ...
        switch ($ml)
        {
            ...
            default:
                ...
                $data['user_id'] = $user_id;
                JPluginHelper::importPlugin( 'joomdlemailinglist' );
                $result = JFactory::getApplication()->triggerEvent ('onJoomdleRemoveListSub', array ($data));
                break;
        }
    }
    ...
    static function delete_course_mailing_list ($course_id, $type)
    {
        ...
        switch ($ml)
        {
            ...
            default:
                $data = array ();
                JPluginHelper::importPlugin( 'joomdlemailinglist' );
                $result = JFactory::getApplication()->triggerEvent ('onJoomdleDeleteList', array ($list_id));
                break;
        }
    }

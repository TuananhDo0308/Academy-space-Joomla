...
class JoomdleHelperProfiletypes
{
    ...
    static function getProfiletypes ($filter_type, $limitstart, $limit, $filter_order, $filter_order_Dir, $search)
    {
        ...
        $result = JFactory::getApplication()->triggerEvent ('OnGetProfiletypes', array($filter_type, $limitstart, $limit, $filter_order, $filter_order_Dir, $search));
    ...
    static function get_profiletype_data ($id)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleprofiletypes' );
        $result = JFactory::getApplication()->triggerEvent ('OnGetProfiletypeData', array($id));
    ...
    static function get_user_profile_role ($username)
    {
        ...
        JPluginHelper::importPlugin( 'joomdleprofiletypes' );
        $result = JFactory::getApplication()->triggerEvent ('OnGetUserProfileId', array($user_id));
        $profile = array_shift ($result);
    ...
    {
        JPluginHelper::importPlugin( 'joomdleprofiletypes' );
        $result = JFactory::getApplication()->triggerEvent('OnAddUserToProfile', array($user_id, $profile_id));
        $profile = array_shift ($result);
    }

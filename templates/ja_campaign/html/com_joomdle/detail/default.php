...
/**
  ...
  * @license      hattp://www.gnu.org/licenses/gpl-3.0.html GNU/GPL
  */
...
/* Định dạng các phần tử trong phần chi tiết của khóa học */
/* (Category, Description, Language, Start Date, Enrol Start Date, Enrol End Date, Enrol Period, Cost, Topics Number) */
.joomdle-coursedetails > div.split_temp > div {
    flex: 1;
    color: grey;
    padding-right: 20px; /* Khoảng cách phải giữa các phần tử */
}

/* Định dạng các nút hoạt động của khóa học */
...
/* Định dạng nút hoạt động */
.joomdle_course_buttons input {
    background-color: blue;
    color: white;
    border: none;
    border-radius: 20px; /* Độ cong của viền */
    padding: 10px 20px;
    cursor: pointer;
...
.joomdle_course_buttons input:hover {
    background-color: darkblue; /* Màu nền thay đổi khi di chuột vào */
}
...
<div class="joomdle-coursedetails<?php echo $this->pageclass_sfx;?>">
    ...
    <div class="joomdle_course_links">
        ...
        if ($show_topics_link) : ?>
            <?php $url = JRoute::_("index.php?option=com_joomdle&view=topics&course_id=$course_id-$course_slug"); ?>

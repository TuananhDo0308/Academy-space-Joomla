...
require_once(JPATH_ADMINISTRATOR.'/components/com_joomdle/helpers/activities.php');
  ...
  function confirmJoomlaSession($method, $params)
    ...
    function changeUsername ($method, $params)
    {
...
//        $username = utf8_decode ($username);
    ...
    function updateUserGroups ($action, $params)
    {
        $course_id = $params[0];
        $course_name = $params[1];
...
class JoomdleControllerWs extends JControllerLegacy
{
    ...
    xmlrpc_server_register_method($xmlrpc_server, "joomdle.changeUsername", "changeUsername");
    ...
    xmlrpc_server_register_method($xmlrpc_server, "joomdle.updateUserGroups", "updateUserGroups");
